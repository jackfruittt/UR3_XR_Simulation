...
/// One child GO per tag ID - moved and activated each frame, hidden when not detected.
public class TagDrawer : System.IDisposable
{
    ...
    public void Dispose()
    {
        // _root may already be null if Unity destroyed it during scene teardown
        // before OnDestroy() ran on the owning MonoBehaviour.
        if (_root != null)
