...
{
    [Serializable]
    public class GraspPlanning_RequestMsg : Message
    {
        public const string k_RosMessageName = "moveit_msgs/GraspPlanning_Request";
        ...
        public GraspPlanning_RequestMsg()
        {
            this.group_name = "";
        ...
        public GraspPlanning_RequestMsg(string group_name, CollisionObjectMsg target, string[] support_surfaces, GraspMsg[] candidate_grasps, CollisionObjectMsg[] movable_obstacles)
        {
        ...
        public static GraspPlanning_RequestMsg Deserialize(MessageDeserializer deserializer) => new GraspPlanning_RequestMsg(deserializer);

        private GraspPlanning_RequestMsg(MessageDeserializer deserializer)
        {
        ...
        {
            return "GraspPlanning_RequestMsg: " +
