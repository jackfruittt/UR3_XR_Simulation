...
{
    [Serializable]
    public class GetCartesianPath_RequestMsg : Message
    {
        public const string k_RosMessageName = "moveit_msgs/GetCartesianPath_Request";
        ...
        public GetCartesianPath_RequestMsg()
        {
        ...
        public GetCartesianPath_RequestMsg(Std.HeaderMsg header, RobotStateMsg start_state, string group_name, string link_name, Geometry.PoseMsg[] waypoints, double max_step, double jump_threshold, double prismatic_jump_threshold, double revolute_jump_threshold, bool avoid_collisions, ConstraintsMsg path_constraints)
        {
            this.header = header;
        ...
        public static GetCartesianPath_RequestMsg Deserialize(MessageDeserializer deserializer) => new GetCartesianPath_RequestMsg(deserializer);

        private GetCartesianPath_RequestMsg(MessageDeserializer deserializer)
        {
        ...
        {
            return "GetCartesianPath_RequestMsg: " +
