...
{
    [Serializable]
    public class GetCartesianPath_ResponseMsg : Message
    {
        public const string k_RosMessageName = "moveit_msgs/GetCartesianPath_Response";
        ...
        public GetCartesianPath_ResponseMsg()
        {
        ...
        public GetCartesianPath_ResponseMsg(RobotStateMsg start_state, RobotTrajectoryMsg solution, double fraction, MoveItErrorCodesMsg error_code)
        {
        ...
        public static GetCartesianPath_ResponseMsg Deserialize(MessageDeserializer deserializer) => new GetCartesianPath_ResponseMsg(deserializer);

        private GetCartesianPath_ResponseMsg(MessageDeserializer deserializer)
        {
        ...
        {
            return "GetCartesianPath_ResponseMsg: " +
