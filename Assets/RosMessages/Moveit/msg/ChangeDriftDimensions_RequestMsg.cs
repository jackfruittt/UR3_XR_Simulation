...
{
    [Serializable]
    public class ChangeDriftDimensions_RequestMsg : Message
    {
        public const string k_RosMessageName = "moveit_msgs/ChangeDriftDimensions_Request";
        ...
        public ChangeDriftDimensions_RequestMsg()
        {
        ...
        public ChangeDriftDimensions_RequestMsg(bool drift_x_translation, bool drift_y_translation, bool drift_z_translation, bool drift_x_rotation, bool drift_y_rotation, bool drift_z_rotation, Geometry.TransformMsg transform_jog_frame_to_drift_frame)
        {
        ...
        public static ChangeDriftDimensions_RequestMsg Deserialize(MessageDeserializer deserializer) => new ChangeDriftDimensions_RequestMsg(deserializer);

        private ChangeDriftDimensions_RequestMsg(MessageDeserializer deserializer)
        {
        ...
        {
            return "ChangeDriftDimensions_RequestMsg: " +
