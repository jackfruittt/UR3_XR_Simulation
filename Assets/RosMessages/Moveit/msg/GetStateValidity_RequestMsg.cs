...
{
    [Serializable]
    public class GetStateValidity_RequestMsg : Message
    {
        public const string k_RosMessageName = "moveit_msgs/GetStateValidity_Request";
        ...
        public GetStateValidity_RequestMsg()
        {
        ...
        public GetStateValidity_RequestMsg(RobotStateMsg robot_state, string group_name, ConstraintsMsg constraints)
        {
        ...
        public static GetStateValidity_RequestMsg Deserialize(MessageDeserializer deserializer) => new GetStateValidity_RequestMsg(deserializer);

        private GetStateValidity_RequestMsg(MessageDeserializer deserializer)
        {
        ...
        {
            return "GetStateValidity_RequestMsg: " +
