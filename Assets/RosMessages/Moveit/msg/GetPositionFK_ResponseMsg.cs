...
{
    [Serializable]
    public class GetPositionFK_ResponseMsg : Message
    {
        public const string k_RosMessageName = "moveit_msgs/GetPositionFK_Response";
        ...
        public GetPositionFK_ResponseMsg()
        {
        ...
        public GetPositionFK_ResponseMsg(Geometry.PoseStampedMsg[] pose_stamped, string[] fk_link_names, MoveItErrorCodesMsg error_code)
        {
        ...
        public static GetPositionFK_ResponseMsg Deserialize(MessageDeserializer deserializer) => new GetPositionFK_ResponseMsg(deserializer);

        private GetPositionFK_ResponseMsg(MessageDeserializer deserializer)
        {
        ...
        {
            return "GetPositionFK_ResponseMsg: " +
