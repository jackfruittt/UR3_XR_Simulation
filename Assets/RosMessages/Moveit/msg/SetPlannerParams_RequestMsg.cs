...
{
    [Serializable]
    public class SetPlannerParams_RequestMsg : Message
    {
        public const string k_RosMessageName = "moveit_msgs/SetPlannerParams_Request";
        ...
        public SetPlannerParams_RequestMsg()
        {
            this.pipeline_id = "";
            this.planner_config = "";
            this.group = "";
        ...
        public SetPlannerParams_RequestMsg(string pipeline_id, string planner_config, string group, PlannerParamsMsg @params, bool replace)
        {
        ...
        public static SetPlannerParams_RequestMsg Deserialize(MessageDeserializer deserializer) => new SetPlannerParams_RequestMsg(deserializer);

        private SetPlannerParams_RequestMsg(MessageDeserializer deserializer)
        {
        ...
        {
            return "SetPlannerParams_RequestMsg: " +
